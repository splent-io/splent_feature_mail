"""
End-to-end tests for splent_feature_mail.
...
Run with:  splent feature:test splent_feature_mail --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_mail")
    assert "splent_feature_mail" in browser.page_source.lower()
